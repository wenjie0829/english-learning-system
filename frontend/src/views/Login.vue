<template>
  <div class="auth-page">
    <div class="auth-layout">
      ...
      <div class="brand-panel">
        ...
        <p class="brand-tagline">用艾宾浩斯遗忘曲线，把单词真正记住</p>
  ...
  <path d="M52 280 H470" stroke="rgba(223,246,168,.35)" stroke-width="2" stroke-dasharray="5 8"/>
          ...
          <div class="curve-caption">
            ...
            <span class="curve-caption-text">每一次复习，都在把遗忘往后推</span>
          </div>
        </div>
      </div>
      ...
      <div class="form-panel">
        <div class="index-card">
          <div class="index-card-tab">LOGIN</div>
          <h2 class="index-card-title dict-heading">登录</h2>
          <p class="index-card-sub">欢迎回来，继续你的学习进度</p>
...
.curve-caption .stage-dots span.filled {
  background: #E8A63C;
}
.curve-caption-text {
  font-size: 13px;
...
<style>
.auth-page{padding:28px;background:#bff28d;background-image:radial-gradient(circle at 12% 12%,#e7ffb9 0 4%,transparent 4.2%),radial-gradient(circle at 82% 84%,#8ecb68 0 8%,transparent 8.2%)}.auth-layout{max-width:1120px;min-height:640px;border:12px solid #0d2617;border-radius:30px;box-shadow:0 28px 70px rgba(13,38,23,.28)}.brand-panel{background:#0d2617;padding:68px 58px;overflow:hidden}.brand-panel::before{content:'';position:absolute;width:380px;height:380px;right:-90px;bottom:-120px;border-radius:48% 52% 35% 65%;background:radial-gradient(circle at 38% 35%,#a7e66f 0 3%,#4e8c47 3.5% 8%,transparent 8.5%),radial-gradient(circle at 70% 55%,#8bd764 0 5%,transparent 5.5%),#183c22;opacity:.9;transform:rotate(-18deg)}.brand-panel>*{position:relative;z-index:1}.brand-mark{background:#c6f19d;border:0;border-radius:50%}.brand-mark-glyph{color:#102318}.brand-title{font-size:42px;letter-spacing:-.05em}.brand-tagline{max-width:300px;color:#cdddc6}.curve-remember{stroke:#c6f19d}.curve-node{fill:#c6f19d;stroke:#0d2617}.form-panel{background:#fffdf7;padding:56px}.index-card{max-width:360px}.index-card-tab{background:#dff3bc;color:#0d2617}.index-card-title{font-size:36px}.primary-btn{border-radius:999px;background:#0d2617;height:50px}.primary-btn:hover:not(:disabled){background:#245b3c}
</style>
<style>
